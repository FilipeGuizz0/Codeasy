...
export default function Trilha({navigation}) {
    return (
      <View style={styles.tela}>
        ...
        <Text style={styles.subTitulo}>Hardware</Text>
        ...
        <View style={styles.espacamento}>
          ...
          <View style={styles.trilha2}>
            ...
            <View style={styles.espacotema2}> <Text style={styles.tema}> Hardware interno/externo</Text></View>
            </View>
          </View>
        ...
        <View style={styles.espacamento2}>
          <View style={styles.trilha4}>
            ...
            <View style={styles.espacotema4}> <Text style={styles.tema}> Placa-mãe</Text></View>
          </View>
          <View style={styles.trilha3}>
            ...
            <View style={styles.espacotema3}> <Text style={styles.tema}> Processador</Text></View>
          </View>
        </View>
      </View>
    );
